...
class BigBrotherStatsTests(unittest.TestCase):
    ...
    def test_directory_has_seed_data_and_filters(self):
        ...
        self.assertNotIn(b"All categories", response.data)
        self.assertIn(b"All families", response.data)
        self.assertIn(b"Recurring families", response.data)
        self.assertIn(
    ...
    def test_recurring_family_filter_includes_in_the_balance(self):
